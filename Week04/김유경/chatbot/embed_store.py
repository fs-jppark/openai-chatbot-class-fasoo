...
class EmbeddingStore:
    ...
    def __init__(self, api_key=OPEN_AI_KEY, embedding_model=EMBEDDING_MODEL):
        ...
        self._collection = self._chroma_client.get_or_create_collection(name=COLLECTION_NAME, embedding_function=self._openai_ef)
    ...
    def query_embedding(self, text, n_results=10):
        ...
        result = self._collection.query(query_embeddings=query_embed, n_results=n_results, include=['documents', 'distances', 'embeddings'])
